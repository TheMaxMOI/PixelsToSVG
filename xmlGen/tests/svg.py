...
fill=("fill", "#2582fb")
r=Tag("rect", [("width", "29"), ("height", "36"), ("rx", "4"), ("transform", "translate(13 8)"), fill], isEmpty=True)
r1=Tag("rect", [("width", "14"), ("height", "14"), ("transform", "translate(18 39) rotate(-45)"), fill], isEmpty=True)
r2=Tag("rect", [("width", "14"), ("height", "14"), ("transform", "translate(7.899 26) rotate(-45)"), fill], isEmpty=True)
r3=Tag("rect", [("width", "14"), ("height", "14"), ("transform", "translate(26.899 26) rotate(-45)"), fill], isEmpty=True)
r4=Tag("rect", [("width", "14"), ("height", "14"), ("transform", "translate(18 13) rotate(-45)"), fill], isEmpty=True)
...
path=Tag("path", [("d", curve), ("transform", "translate(13.5 15.689)"), ("fill", "#fff")], isEmpty=True)

svg=Tag("svg")
svg=(
svg.addAttribute(("width", "53px"))
.addAttribute(("height", "52px"))
