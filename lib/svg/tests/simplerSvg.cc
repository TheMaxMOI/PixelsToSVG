...
int main(void)
{
    ...
    c.ellipticalArcTo(2.784, 2.784, 0, 0, 1, 14.077, 5.0329999999999995);
    c.ellipticalArcTo(2.684, 2.684, 0, 0, 1, 16.545, 6.283999999999999);
    c.ellipticalArcTo(7.283, 7.283, 0, 0, 1, 17.317, 10.043999999999999);
    c.ellipticalArcTo(6.981, 6.981, 0, 0, 1, 16.456, 13.843999999999998);
    c.ellipticalArcTo(2.79, 2.79, 0, 0, 1, 13.968, 15.171);
    c.stopHere();
    c.moveTo(14.05, 6.3);
    c.ellipticalArcTo(1.365, 1.365, 0, 0, 0, 12.761000000000001, 7.281);
    c.ellipticalArcTo(7.967, 7.967, 0, 0, 0, 12.347000000000001, 10.224);
    c.ellipticalArcTo(7.039, 7.039, 0, 0, 0, 12.761000000000001, 12.982);
    c.ellipticalArcTo(1.345, 1.345, 0, 0, 0, 14.029000000000002, 13.901);
    c.ellipticalArcTo(1.323, 1.323, 0, 0, 0, 15.297000000000002, 12.961);
    c.ellipticalArcTo(7.716, 7.716, 0, 0, 0, 15.690000000000003, 10.134);
    c.ellipticalArcTo(7.991, 7.991, 0, 0, 0, 15.3, 7.258);
