...
inline std::mt19937_64 &getRDMengine()
{
    thread_local std::mt19937_64 engine(std::random_device{}());
    return engine;
}

inline double my_round(double x, int p)
{
...
explicit Rounder::Rounder(int p) : precision_{p} {}
...
inline double norm2(const std::array<double, 2> &v)
{
...
inline double normInf(const std::array<double, 2> &v)
{
